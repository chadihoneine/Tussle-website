...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 09:41 AM
...
(37, 1, 'tournament joined', 'tournamentview/id=3', NULL, '2021-05-01 07:47:30', 0),
(38, 1, 'tournament joined', 'tournamentview/id=3', NULL, '2021-05-01 07:50:18', 0),
(39, 1, 'tournament joined', 'tournamentview/id=5', NULL, '2021-05-01 07:53:14', 0);
...
CREATE TABLE `tournaments` (
  ...
  `nbOfParticipants` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tournaments` (`tournamentID`, `accountID`, `category`, `time`, `place`, `duration`, `description`, `isdeleted`, `location`, `tournamentscol`, `issolo`, `title`, `nbOfParticipants`) VALUES
(3, 2, 'gaming', '2021-02-27 11:01:39', 'online', '2021-02-28 11:01:39', 'mn ', NULL, 'nm', 'b', 'true', 'pubg', 4),
(5, 2, 'gaming', '2021-02-27 11:01:39', 'online', '2021-02-28 17:59:54', 'v,', NULL, 'jb', ',m b', 'false', 'dota', 2),
(7, 1, 'a', '0001-01-01 01:01:00', 'a', '0001-01-01 11:01:00', 'a', 0, 'a', 'a', 'true', 'a', 0);
...
--
ALTER TABLE `notifications`
  MODIFY `notificationsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `team`
  MODIFY `teamID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
...
--
ALTER TABLE `tournaments`
  MODIFY `tournamentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
