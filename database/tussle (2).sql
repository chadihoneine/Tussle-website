...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2021 at 04:51 PM
...
(1, 0, 'admin@admin.com', 'admin', 'beirut', '1998-01-01 00:00:00', '1998-01-01', 'male', NULL, 'mhmd', 0x6466646466, 'mohammad', 'sonji', 'beirut', 'nthn'),
(2, 0, 'ms@admin.com', 'admin', 'Lebanon', NULL, '1998-01-01', 'male', NULL, 'MS', 0x696d616765732f313631333431313031312e6a7067, 'Mohammad', 'Sonji', 'beirut', NULL),
(3, 1, 'mohammadsonji360@gmail.com', 'admin123', 'Lebanon', NULL, '1998-01-01', 'male', NULL, 'staff@admin.com', NULL, 'mohammad', 'sonji', 'beirut', NULL),
(13, 1, 'user@staff.com', 'admin', 'Lebanon', NULL, '1995-11-11', 'male', NULL, 'admin@admin.com', NULL, 'zkdjb', 'lkhl', 'kjg', NULL);
...
INSERT INTO `events` (`eventID`, `accountID`, `time`, `place`, `duration`, `description`, `location`, `title`, `private`) VALUES
(5, 1, '2022-12-12 15:30:00', 'online', NULL, 'dota tournament', NULL, 'dota', 'yes'),
...
(66, 1, '2021-11-11 11:11:00', 'online', NULL, 'ps4', NULL, 'cod', 'yes'),
(67, 1, '2020-11-11 11:11:00', 'z', NULL, 'z', NULL, 'zzz', ''),
(68, 1, '2021-11-11 11:11:00', 'z', NULL, 'z', NULL, 'american football', 'no'),
...
(76, 1, '1998-01-01 00:00:00', 'online', NULL, 'xyz', '-', 'bobg', 'no'),
(79, 1, '2022-02-22 11:11:00', 'beirut', NULL, 'kjbkjb', NULL, 'ps5', 'yes');
...
(37, 1, 'event invitation', '57', NULL, '2021-04-05 14:50:00', 0);
...
(3, 3, 'yes', 'whats your name'),
(4, 4, 'xxx', 'xyz'),
(5, 4, 'zzz', 'zyx'),
(6, 4, 'yes, no, maybe', 'whats your name');
...
(2, '2021-04-28', '2021-06-05'),
(3, '2021-04-20', '2021-04-30'),
(4, '2021-04-20', '2021-05-07');
...
(6, 2, 'gaming', '2021-03-12 10:16:00', 'beirut', NULL, NULL, NULL, NULL, NULL, 'false', 'paintball');
...
--
ALTER TABLE `notifications`
  MODIFY `notificationsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `team`
  MODIFY `teamID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
